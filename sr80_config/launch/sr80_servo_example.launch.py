...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("SR80", package_name="sr80_config")
    ...
    servo_yaml = load_yaml("sr80_config", "config/sr80_simulated_config.yaml")
    ...
    # RViz
    rviz_config_file = (
        get_package_share_directory("sr80_config") + "/config/moveit_servo.rviz"
    )
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("sr80_config"),
        "config",
