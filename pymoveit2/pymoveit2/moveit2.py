...
class MoveIt2:
    ...
    def __init_move_action_goal(
        ...
        move_action_goal.request.workspace_parameters.min_corner.x = -3.0
        move_action_goal.request.workspace_parameters.min_corner.y = -3.0
        move_action_goal.request.workspace_parameters.min_corner.z = -3.0
        move_action_goal.request.workspace_parameters.max_corner.x = 3.0
        move_action_goal.request.workspace_parameters.max_corner.y = 3.0
        move_action_goal.request.workspace_parameters.max_corner.z = 3.0
